...
RVCore_ns::RV64_ExecFeedbackCode_e RVCore_ns::RV64SV39_MMU::vaddrAtomicMemOperation(uint64_t start_addr,
                                                              uint64_t size,
                                                              AMO_Funct_enum op,
                                                              int64_t src,
                                                              int64_t &dst) {
...
RVCore_ns::RV64_ExecFeedbackCode_e RVCore_ns::RV64SV39_MMU::vaddrLoadReserved(uint64_t begin_addr, uint64_t size, uint8_t *buffer) {
    const SATP_Reg_t* satp_reg = (SATP_Reg_t*)&satp;
    const CSReg_MStatus_t* mstatus = (CSReg_MStatus_t*)&status;
...
RVCore_ns::RV64_ExecFeedbackCode_e RVCore_ns::RV64SV39_MMU::vaddrStoreConditional(uint64_t begin_addr,
                                                            uint64_t size,
...
bool RVCore_ns::RV64SV39_MMU::pa_amo_op(uint64_t pa, uint64_t size, AMO_Funct_enum op, int64_t src, int64_t &dst) {
    int64_t res;
    if (size == 4) {
        int32_t res32;
